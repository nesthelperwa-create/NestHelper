...
const faqs = [
  ...
  ["Do recurring resets bill automatically?", "Not by default. Whole Home Reset can include weekly, bi-weekly, or monthly maintenance requests after review, while Specific Area(s) Reset uses repeat area support for selected rooms only. NestHelper still reviews each recurring or repeat-support payment before sending it so families are not auto-charged for a visit that has not been confirmed."],
