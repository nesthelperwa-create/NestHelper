...
const faqs = [
  ...
  ["How does laundry pricing work?", "Laundry Rescue intro launch pricing is $59 minimum. That minimum includes pickup, wash, dry, fold, return, and up to about 26.2 lbs of laundry. Additional laundry above the included weight is $2.25/lb. Eco-friendly detergent is available. Laundry is dry-weighed at pickup, add-ons are reviewed, and any final balance is handled by the option selected during checkout: auto-charge after review or final invoice before delivery."],
