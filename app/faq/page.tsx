...
const faqs = [
  ...
  ["Why is availability limited?", "NestHelper is growing intentionally. We accept a limited number of requests at a time so families receive reliable, thoughtful service instead of rushed or overbooked support. Requesting help does not guarantee a confirmed booking."],
  ["Why does NestHelper cost more than hiring someone from a local group?", "NestHelper is not trying to be the cheapest option. Pricing includes request review, service coordination, clear scope, an insured local service, checked helpers or vetted partners, secure payment, and follow-up after service."],
...
export default function FAQPage() {
  return (
    <>
      <PageHero eyebrow="FAQ" title="Clear answers before you request help." text="Simple policies, clear expectations, and answers to common pricing, availability, trust, laundry, and service-scope questions." />
