...
export const metadata: Metadata = {
  ...
  description:
    "View NestHelper household help services for Woodinville and nearby Eastside/Northshore families, including home reset help, Laundry Rescue, errand help, organizing, and household support. No childcare.",
  alternates: {
    canonical: `${siteConfig.url}/services`,
  },
  openGraph: {
    title: "Household Help Services, Home Reset, Laundry & Errands | NestHelper",
    description:
      "Managed household support, home reset packages, laundry help, organizing, and errand help for busy families. No childcare.",
      ...
      <section className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-balance mt-4 text-3xl font-black leading-tight text-nest-teal sm:text-5xl">Household help, home reset support, laundry help, organizing, and errands when the house feels like too much.</h2>
          </div>
          <div className="pro-card rounded-[2rem] p-6">
            ...
            <p className="mt-3 font-medium leading-7 text-nest-ink/70">
              Each card shows the essentials first. Open a package to see what is included, then request the one that fits your family best. NestHelper keeps the scope focused on reviewed home help, laundry, errands, organizing, and reset tasks — not childcare or babysitting.
            </p>
          </div>
        </div>
