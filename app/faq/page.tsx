...
const faqs = [
  ["What does NestHelper help with?", "NestHelper gives busy families extra hands around the home with Parent Reset Plan visits, optional simple in-home meal prep support, whole-home cleaning, kitchen and bath resets, garage and area resets, Move Prep & Home Reset, move-in / move-out cleaning, laundry rescue, errands, organizing, and practical family support. We do not provide childcare, unsupervised babysitting, medical care, elder care, or emergency services."],
  ["Do you serve outside Bothell or in Snohomish County?", `Yes. NestHelper serves ${siteConfig.serviceArea}. Snohomish County requests are handled as select nearby areas by request, and availability depends on service type, travel time, helper coverage, schedule, and any required local endorsement. Submit a request and we will confirm before sending any payment link.`],
  ["Which service should I choose for whole-home cleaning, selected rooms, or moving?", "Choose Parent Reset Plan for a 3-hour busy-parent reset in selected family spaces with organizing, light cleaning, and child-safe disinfecting. Choose Whole Home Cleaning for the entire home, first-time deep cleans, first-time deep clean plus recurring maintenance, or weekly, bi-weekly, and monthly full-home support. Choose Specific Area(s) Reset when you only need selected rooms or focused areas such as kitchen, bathroom(s), pantry, fridge, oven, laundry area, garage, or a few rooms. Choose Move Prep & Home Reset for in-home sorting, open-first essentials boxes, QR Smart Labels, packing supply kits, donation sorting, light unpacking, after-move kitchen setup, and getting settled. Choose Move-In / Move-Out Cleaning for empty or mostly empty homes before moving in, after moving out, or before listing/renting. Choose Laundry Rescue separately for pickup, wash, dry, fold, and return laundry help."],
  ["Is NestHelper a moving company?", "No. Movers handle transportation and heavy lifting. NestHelper helps with in-home sorting, organizing, labeling, open-first boxes, light unpacking, cleaning, and after-move reset support. Move-out cleaning can be requested but is quoted separately."],
  ...
  ["How does laundry pricing work?", "Laundry Rescue intro launch pricing is $59 minimum. That minimum includes pickup, wash, dry, fold, return, and up to about 26.2 lbs of final dry-weight laundry. After laundry is washed, dried, and folded, final pricing is based on final dry weight. Additional laundry above the included amount is $2.25/lb. Eco-friendly detergent is available. Any final balance is handled by the option selected during checkout: auto-charge after review or final invoice before delivery."],
