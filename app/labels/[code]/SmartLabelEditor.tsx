        ...
        <div className="min-w-0 p-4 sm:p-7">
          ...
          {!publicState ? (
            ...
            <div className="grid gap-5">
              <div className="rounded-[1.6rem] border border-amber-200 bg-amber-50 p-4 text-sm font-semibold text-amber-800"><ShieldAlert className="mr-2 inline-block" size={16} /> Legacy test label: this older unowned record remains open for NestHelper testing. Retail Smart Labels still use account activation and claiming before private customer data is saved.</div>
