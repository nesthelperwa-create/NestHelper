...
const faqs = [
  ...
  ["Does checkout include Washington sales tax?", "The checkout and invoicing setup is designed to calculate applicable Washington sales tax through Stripe based on the service address or customer address once live tax setup is complete."],
