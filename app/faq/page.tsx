...
const faqs = [
  ...
  ["How does laundry pricing work?", "Laundry Rescue intro launch pricing is $59 minimum + $2.25/lb. It includes wash, dry, fold, and return; eco-friendly detergent is available. The non-refundable minimum/deposit is credited before tax toward the final total. Laundry is weighed dry at pickup, add-ons are applied, and the final balance is handled by the option selected during checkout: auto-charge after review or final invoice before delivery."],
