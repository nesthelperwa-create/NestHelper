...
const faqs = [
  ...
  ["Do you offer recurring reset pricing?", "Yes. After a first completed reset, eligible families may request recurring support. Weekly and every-2-weeks rates are available only when the schedule, scope, service area, and helper fit are consistent. Monthly refresh visits usually stay at standard pricing because they do not create the same scheduling consistency."],
  ["Why is the first reset still standard price?", "The first visit takes more review, communication, setup, and fit-checking. Recurring rates are not discounted trials; they are modest loyalty rates for families planning ongoing support after the first completed standard visit."],
