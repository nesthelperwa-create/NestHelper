...
function serializeAdminLabel(code: string, data: Record<string, unknown>, reservedOnly = false) {
  ...
  return {
    ...
    ownerUid: reservedOnly ? "" : typeof data.ownerUid === "string" ? data.ownerUid : "",
    ownerEmail: reservedOnly ? "" : typeof data.ownerEmail === "string" ? data.ownerEmail : "",
    migratedFromLegacy: !reservedOnly && Boolean(data.migratedFromLegacy),
