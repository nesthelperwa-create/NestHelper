...
const faqs = [
  ...
  ["How does laundry pricing work?", "Laundry Rescue intro launch pricing is $59 minimum. That minimum includes pickup, wash, dry, fold, return, and up to about 26.2 lbs of final dry-weight laundry. After laundry is washed, dried, and folded, final pricing is based on final dry weight. Additional laundry above the included amount is $2.25/lb. Eco-friendly detergent is available. Any final balance is handled by the option selected during checkout: auto-charge after review or a final payment link before delivery."],
