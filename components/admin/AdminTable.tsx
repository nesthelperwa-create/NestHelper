      ...
      {selected && (
        <div className="fixed inset-0 z-[300] overflow-y-auto bg-black/50 px-2 pb-4 pt-2 sm:px-4 sm:py-4">
          <div className="mx-auto min-h-[calc(100dvh-1rem)] w-full max-w-6xl overflow-visible rounded-3xl bg-white p-4 shadow-2xl sm:min-h-0 sm:max-h-[92dvh] sm:overflow-auto sm:p-6">
            ...
            {collectionName === "serviceRequests" && (
              <div id="admin-section-internal-notes" className="scroll-mt-28 mb-5 rounded-3xl border border-[#eadfc8] bg-white p-4 shadow-sm sm:p-5">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  <div>
            ...
            {collectionName === "serviceRequests" && selected.service === "laundry-rescue" && (
              <div id="admin-section-repeat-laundry" className="scroll-mt-28 mb-5 rounded-3xl border border-[#eadfc8] bg-[#fbf6ea] p-4 shadow-sm sm:p-5">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                  <div>
