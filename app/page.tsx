            ...
            <div className="mx-auto mt-6 max-w-2xl rounded-[1.8rem] border border-nest-gold/16 bg-white/70 p-4 text-left shadow-sm backdrop-blur">
              ...
              <div id="service-area" className="mt-4 scroll-mt-24 border-t border-nest-gold/14 pt-3 text-left">
                ...
                <p className="mt-2 text-xs font-semibold leading-5 text-nest-ink/64">
                  Bothell, Woodinville, Kenmore, Kirkland, Redmond, Mill Creek, Lynnwood, Edmonds, Mountlake Terrace, Snohomish, and Mukilteo. Other nearby Eastside, Northshore, and South Snohomish County areas may be reviewed by request. Send your address and we will confirm availability before payment.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {["Bothell", "Woodinville", "Kenmore", "Kirkland", "Redmond", "Mill Creek", "Lynnwood", "Edmonds", "Mountlake Terrace", "Snohomish", "Mukilteo"].map((area) => (
