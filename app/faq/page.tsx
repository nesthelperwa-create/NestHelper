...
const faqs = [
  ...
  ["What are NestHelper Smart Labels?", "Smart Labels are customer-owned QR stickers included at no extra cost with qualifying resets. Families can use them for bins, closets, shelves, moving boxes, seasonal items, garages, storage areas, pantries, and playrooms. A family can scan a label to update the name, location, items inside, notes, and small photos. Labels start with no PIN by default, and the family can add an optional 4-digit PIN later for privacy."],
  ["What is Smart Label Setup?", "Smart Label Setup is an optional paid add-on when you want NestHelper to do more than leave the labels with you. Setup starts at $49 and can include placing labels, scanning them, naming each bin or area, documenting what is inside, adding notes/photos, and showing the family how to keep everything updated. Full Smart Label Setup starts at $79 for larger spaces like garages, storage areas, moving boxes, pantry systems, and playrooms. Additional documentation or setup can be quoted as needed."],
